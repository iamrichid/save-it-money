    ...
    <div className="relative flex flex-col h-full w-full bg-background-light dark:bg-background-dark">
      ...
      <main className="flex-1 overflow-y-auto no-scrollbar px-6 py-6 pb-32 space-y-8">
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-white dark:bg-surface-dark p-4 rounded-3xl shadow-sm border border-black/5 dark:border-white/5">
        ...
        <div className="bg-white dark:bg-surface-dark p-6 rounded-3xl shadow-sm border border-black/5 dark:border-white/5">
